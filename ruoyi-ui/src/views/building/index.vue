    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['building:building:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['building:building:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="楼栋主键" align="center" prop="buildId" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="区域" prop="location">
          <el-select v-model="form.location" placeholder="请选择区域">
            <el-option value="南苑">南苑</el-option>
            <el-option value="北苑">北苑</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="楼栋名称" prop="buildName">
...
<script>
import { listBuilding, getBuilding, delBuilding, addBuilding, updateBuilding, exportBuilding } from "@/api/building/building";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getBuilding(buildId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除该宿舍楼?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delBuilding(buildIds);
        }).then(() => {
          this.getList();
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有宿舍楼数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
